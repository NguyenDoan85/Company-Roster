...
connection.connect((error) => {
  ...
  console.log(``);
  console.log(chalk.greenBright.bold(figlet.textSync("Company Roster")));
  console.log(``);
  console.log(
    `                                                          ` +
      chalk.greenBright.bold("Created By: Nguyen Doan")
  );
  console.log(``);
  console.log(
    chalk.yellow.bold(
      ...
      connection.query(roleSql, (error, data) => {
        ...
        inquirer
          ...
          .then((roleChoice) => {
            ...
            crit.push(role);
            const managerSql = `SELECT * FROM role`;
            connection.query(managerSql, (error, data) => {
              if (error) throw error;
              const managers = data.map(({ id, title }) => ({
                name: title,
                value: id,
              }));
              inquirer
...
const addRole = () => {
  ...
  connection.query(sql, (error, response) => {
    ...
    deptNamesArray.push("CreateDepartment");
    deptNamesArray.push("Exit");
    inquirer
      .prompt([
        {
          name: "departmentName",
      ...
      .then((answer) => {
        if (answer.departmentName === "Exit") {
          viewAllRoles();
        }
        if (answer.departmentName === "CreateDepartment") {
          addDepartment();
        } else {
    ...
    connection.query(sql, (error, response) => {
      ...
      inquirer
        ...
        .then((answer) => {
          ...
          if (answer.employeeNamesArray === "Exit") {
            promptUser();
          };
          response.forEach((role) => {
...
const removeDepartment = () => {
  ...
  connection.query(sql, (error, response) => {
    ...
    departmentNamesArray.push("Exit");
    inquirer
      .prompt([
        {
          name: "chosenDept",
      ...
      .then((answer) => {
        let departmentId;
        if (answer.departmentNamesArray === "Exit") {
          promptUser();
        };
        response.forEach((department) => {
